...
<header>
	<div class="container">
		<div class="row">
			...
			<!--<div class="titulo" class="col-lg-8">
				<p id="p1">Centro de Capacitación de Informática Empresarial</p>
			</div>-->
		</div>
	</div>
</header>
	...
	<div class="row">
		...
		<aside>
			...
			<div class="subsection2">
				...
				<div class="contenedor">
					<ul>
						<li><a id="facebook" target="_blank">Facebook</a></li><br>
						<li><a id="twitter" target="_blank" href="">Twitter</a></li><br>
						<li><a id="youtube" target="_blank" href="">Youtube</a></li>
					</ul>
				</div>
			</div>
